...
const prompts = [
    ...
    { prompt_name:"material_list", 
        prompt: "list top 2 materials for topic <topic> under the subject <main_topic> in a numbered list. do not add any other descriptions or sentences. do not provide book names. Add the complexity of each material in a scale of 1 to 5 in this format : Material Name (Complexity: 3)." },
    ...
    { prompt_name: "material_quiz_generation", 
        ...
        prompt: "generate a list of 3 quiz questions on <topic> along with 3 line answers that can help graduate students of <main_topic> learn the topic better."},
    { prompt_name: "material_question_paper_generation", 
        mat_type: "exam questions",
        prompt: "generate a list of 3 examination questions on <topic> along with comprehensive 10 line answers that can help graduate students of <main_topic> prepare for their graduate level examination."},
    { prompt_name: "material_summary_generation", 
        mat_type: "summary",
        prompt: "generate a 120 word summary on the <topic> so that a graduate student of <main_topic> can quickly recollect jist on the topic."},
    { prompt_name: "material_interview_question_generation", 
        mat_type: "interview questions",
        prompt: "generate a list of 5 interview questions on <topic> that can help graduate students of <main_topic> prepare for post graduation job interview."},
]
